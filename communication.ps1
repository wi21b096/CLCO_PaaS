...
# az resource update --ids "/subscriptions/7d3b23f7-171d-40d3-b2a0-f0a9d98ddee0/resourceGroups/clco_grp6/providers/Microsoft.CognitiveServices/accounts/clco-grp6-ai-service" --set properties.publicNetworkAccess="Disabled" # not working with disabled flag
