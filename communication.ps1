...
az network vnet create --resource-group clco_grp6 --location LOCATION --name clco_grp6_network --address-prefixes 10.0.0.0/16
...
az resource update --ids clco_grp6_network_v2 --set properties.publicNetworkAccess="Disabled"
az webapp update --resource-group clco_grp6 --name clco-grp6-webapp --https-only
az webapp vnet-integration add --resource-group clco_grp6 --name clco-grp6-webapp --vnet clco_grp6_network_v1 --subnet clco_grp6_network
