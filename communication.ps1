...
az cognitiveservices account create --name clco-grp6-ai-service --kind TextAnalytics --sku B1 --location westeurope --resource-group clco_grp6 --yes
...
az webapp update --resource-group clco_grp6 --name clco-grp6-webapp-1 --https-only
az webapp update --resource-group clco_grp6 --name clco-grp6-webapp-2 --https-only
az webapp update --resource-group clco_grp6 --name clco-grp6-webapp-3 --https-only
az webapp vnet-integration add --resource-group clco_grp6 --name clco-grp6-webapp-1 --vnet clco_grp6_network --subnet clco_grp6_network_v1
az webapp vnet-integration add --resource-group clco_grp6 --name clco-grp6-webapp-2 --vnet clco_grp6_network --subnet clco_grp6_network_v1
az webapp vnet-integration add --resource-group clco_grp6 --name clco-grp6-webapp-3 --vnet clco_grp6_network --subnet clco_grp6_network_v1
...
az webapp config appsettings set --resource-group clco_grp6 --name clco-grp6-webapp-1 --settings AZ_ENDPOINT="https://clco-grp6-ai-service.cognitiveservices.azure.com/" AZ_KEY="ccd6315aed6842b0884b9775c5077f55"
az webapp config appsettings set --resource-group clco_grp6 --name clco-grp6-webapp-2 --settings AZ_ENDPOINT="https://clco-grp6-ai-service.cognitiveservices.azure.com/" AZ_KEY="ccd6315aed6842b0884b9775c5077f55"
az webapp config appsettings set --resource-group clco_grp6 --name clco-grp6-webapp-3 --settings AZ_ENDPOINT="https://clco-grp6-ai-service.cognitiveservices.azure.com/" AZ_KEY="ccd6315aed6842b0884b9775c5077f55"
