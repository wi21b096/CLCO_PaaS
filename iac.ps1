...
az deployment group create --name clco-grp6-storage --resource-group clco_grp6 --template-file ./azuredeploy.json --parameters storageName=clcogrp6sto storageSKU=Standard_LRS
